...
extern  int     m[4];
extern  int     m_slice[4][40];
extern  int     trackallocflag2;  /* checkflag if mega, c4, t4 already allocated */
extern  int     trackallocflag;  /* checkflag if mega_slice, c4_slice, t4_slice already allocated */
...
extern	FILE   	*fp1, *fp2, *fp3, *fp4, *fpp, *fp5;	/* file pointers */
...
extern  target          *t4_slice[4][4][40];
extern  int             nt4[4][4];
extern  int				nt4_slice[4][4][40];
extern  corres          *corrp;
extern  corres	       	*corrc;
extern  corres	       	*corrn;
extern  corres	       	*c4[4];
extern  corres          *c4_slice[4][40];
extern  trackparameters tpar;
extern  scanparameters  scan_par;
extern P *mega[4];
extern P *mega_slice[4][40];
...
void read_ascii_data_first();
void rotate_dataset_first();
void sort_slice();
void write_ascii_data_slice();
void read_ascii_data_back();
