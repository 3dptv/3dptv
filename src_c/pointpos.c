...
void pos_from_ray(Exterior Ex[4], Interior I[4], Glass G[4], ap_52 ap[4], mm_np mm, 
				 double x1, double y1, double x2, double y2, 
				 double x3, double y3, double x4, double y4, 
				 double *Xp, double *Yp, double *Zp, double *dist)
{
...
void det_lsq_3d(Exterior Ex[4], Interior I[4], Glass G[4], ap_52 ap[4], mm_np mm, 
				double x1, double y1, double x2, double y2, 
				double x3, double y3, double x4, double y4, 
				double *Xp, double *Yp, double *Zp)
{
...
void det_lsq_3 (Exterior Ex[3], Interior I[3], Glass G[3], ap_52 ap[3], mm_np mm, 
...
void det_lsq_4 (Exterior Ex[4], Interior I[4], Glass G[4], ap_52 ap[4], mm_np mm, 
				double x1, double y1, double x2, double y2, 
				double x3, double y3, double x4, double y4, 
				double *Xp, double *Yp, double *Zp)
{
...
void det_lsq_2 (Exterior Ex[2], Interior I[2], Glass G[2], ap_52 ap[2], mm_np mm, 
				double x1, double y1, double x2, double y2, 
				double *Xp, double *Yp, double *Zp)
{
	int 	i, itnum, stopflag;
