...
void  multimed (Exterior ex, mm_3p mm, double X, double Y, double Z, 
				double *Xq, double *Yq)
{
	int    i, it=0;
...
#ifdef EVER_CALLED		// Unused function, ad holten 12-2012
void  multimed_nlay_true (Exterior ex, Glass gl,mm_np mm, 
...
#ifdef EVER_CALLED		// Unused function, ad holten 12-2012
void back_trans_Point_back(double X_t, double Y_t, double Z_t,
						   mm_np mm, Glass G, double cross_p[], double cross_c[],
